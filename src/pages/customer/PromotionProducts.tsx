...
const PromotionProducts: React.FC = () => {
  ...
  const filteredProducts = promotionProducts.filter(product => {
    ...
    return product.promotionType === filterType;
  });
      ...
      <div className="px-4 py-4">
        {filteredProducts.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">행사 상품이 없습니다</h3>
            <p className="text-gray-500 mb-4">현재 진행 중인 특가 행사가 없습니다.</p>
            <button
