                            ...
                            <div className="flex items-start space-x-3">
                              ...
                              <div className="flex flex-col space-y-1">
                                ...
                                {hasStock && (
                                  ...
                                  >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.5 5M7 13l2.5 5m6-5v5a2 2 0 01-2 2H9a2 2 0 00-2-2v-5m6-5V6a2 2 0 00-2-2H9a2 2 0 00-2 2v2" />
                                    </svg>
                                  </button>
                                )}
                              </div>
