...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      user_coupons: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "user_coupons_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      st_astwkb: {
        Args:
          | { geom: unknown[]; ids: number[]; prec?: number; prec_z?: number; prec_m?: number; with_sizes?: boolean; with_boxes?: boolean }
          | { geom: unknown; prec?: number; prec_z?: number; prec_m?: number; with_sizes?: boolean; with_boxes?: boolean }
        Returns: string
      }
      st_asx3d: {
